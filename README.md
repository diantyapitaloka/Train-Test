...
- Probabilistic Outputs: Instead of just predicting a label, Iris is great for learning about predict_proba. Hence, you can see how a model will be 99% sure about a Setosa, but only 55% sure when deciding between a Versicolor and a Virginica.
