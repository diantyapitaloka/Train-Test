...
- Normalization & Scaling: Algorithms like KNN or SVM are sensitive to the magnitude of the features. In addition, because sepal lengths are generally larger than petal widths, Iris is a perfect sandbox for practicing Min-Max Scaling or Standardization to see how they impact distance-based calculations.
