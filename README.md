...
- Outlier Identification: Within the 150 samples, there are a few "rebel" flowers that sit closer to the wrong clusters. Hence, this allows students to practice Box Plots and Z-Score analysis to decide whether a point is a natural variation or a measurement error.
...
- Confusion Matrix Interpretation: With three species, the Confusion Matrix becomes a $3 \times 3$ grid. Hence, this teaches students how to read "off-diagonal" errors—specifically observing that the models rarely confuses Setosa with others, but often confuses the other two.
...
- Normalization & Scaling: Algorithms like KNN or SVM are sensitive to the magnitude of the features. In addition, the most of because sepal lengths are generally larger than petal widths, Iris is a perfect sandbox for practicing Min-Max Scaling or Standardization to see how they impact distance-based calculations.
