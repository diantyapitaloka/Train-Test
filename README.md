...
- Outlier Identification: Within the 150 samples, there are a few "rebel" flowers that sit closer to the wrong cluster. This allows students to practice Box Plots and Z-Score analysis to decide whether a point is a natural variation or a measurement error.
