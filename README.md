...
- Linear vs. Non-Linear Separability: The Iris datasets is famous for show that while one class (Setosa) is linearly separables from the other, the remaining two (Versicolor and Virginica) overlap slightly. This teaches you when a simple linear model might fail.
