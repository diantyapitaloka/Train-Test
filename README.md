...
- Confusion Matrix Interpretation: With three species, the Confusion Matrix becomes a $3 \times 3$ grid. Hence, all the teaches students how to read "off-diagonal" errors—specifically observing that to the models rarely confuses Setosa with others, but often confuses the other two.
