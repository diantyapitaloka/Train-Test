...
- Linear vs. Non-Linear Separability: The Iris datasets is famous for showing that while one class (Setosa) is linearly separables from the others, the remaining two (Versicolor and Virginica) overlap slightly. This teaches you when a simple linear model might fail.
